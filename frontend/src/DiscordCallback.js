      ...
      <div className="callback-container">
        <div className="callback-card">
          <div className="callback-header">
            ...
            <h1 className="callback-title">Connexion Discord</h1>
          </div>
          ...
          <div className="callback-content">
            {status === 'loading' && (
              <div className="callback-state">
                ...
                <p className="callback-message">Traitement de votre connexion Discord...</p>
              </div>
            )}
            ...
            {status === 'success' && (
              <div className="callback-state">
                ...
                <h3 className="state-title">Connexion réussie !</h3>
                <p className="callback-message">Votre compte Discord a été connecté avec succès à FDM.</p>
                <p className="callback-note">Vous allez être redirigé vers votre profil...</p>
              </div>
            )}
            ...
            {status === 'error' && (
              <div className="callback-state">
                ...
                <h3 className="state-title">Erreur de connexion</h3>
                <p className="callback-message">{error}</p>
                <button onClick={handleRetry} className="btn btn-discord">
                  Retour à l'accueil
                </button>
              </div>
            )}
